...
```{r, fig.align='center', out.width="100%", fig.width="100%", echo = FALSE, fig.alt= "The AMP/ASCO/CAP Standards and Guidelines classify somatic variants into four Tiers and four Levels according to their clinical significance and level of evidence"}
