...
The discussion of functional evidence and oncogenic evidence in the next section will closely mirror the way these types of evidence are handled in the CIViC knowledgebase [@Danos2019], which will be discussed in a later chapter. Other knowledgebases, such as OncoKB make similar distinctions between oncogenic and functional evidence
