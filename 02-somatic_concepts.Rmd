...
In order to address this problem, databases containing information on the clinical impact of tumor variants have been created. These databases may be the result of private efforts and siloed for use by a particular group. A different approach is to create curated knowledgebases available to the community at cost with payments going to fund further curation. Yet another model is to create public knowledgebases for variant clinical interpretation which leverage public curation with expert moderation. 
